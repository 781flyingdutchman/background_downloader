...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    // Always call resumeFromBackground after setting up callbacks and listener
    FileDownloader().resumeFromBackground();
    // If you are tracking tasks in the database, then also reschedule missing
    // tasks after a 5 second delay
    // Future.delayed(const Duration(seconds: 5),
    //     () => FileDownloader().rescheduleMissingTasks());
  }
