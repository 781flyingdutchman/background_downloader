...
* Changes the trigger for Android User Initiated Data Transfer (UIDT) from configuration to task priority. Setting `priority: 0` (max priority) on Android 14+ will now trigger UIDT if a notification is also configured.
